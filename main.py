...
def mainGame():
    ...
    while True:
        ...
        # if crashTest: # Comment off this to allow game to continue without penalty
        #     return     
        ...
        # # Save image
        # if counter%20==0:
        #     pygame.image.save(SCREEN, 'doc/'+str(counter)+'.png')
        #     cv2.imwrite('doc/'+str(counter)+'_.png', img)
        # counter += 1
